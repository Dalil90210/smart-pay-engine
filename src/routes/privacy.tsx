  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="prose prose-invert max-w-none text-sm leading-relaxed text-muted-foreground [&_h2]:mt-8 [&_h2]:text-base [&_h2]:font-semibold [&_h2]:text-foreground [&_a]:text-cyan [&_a]:underline [&_a]:underline-offset-2 [&_p]:mt-2 [&_ul]:mt-2 [&_ul]:list-disc [&_ul]:pl-5">
        <p>
          This page is maintained by Smart Pay Engine to explain what information the app
          collects, how we use it, and the controls you have. Smart Pay Engine is a sandbox
          product — no real money moves through it.
        </p>

        <h2>Information we collect</h2>
        <ul>
          <li>
            <strong>Account data</strong> — email address and authentication identifiers you
            provide when signing in.
          </li>
          <li>
            <strong>App activity</strong> — sandbox transactions, invoices, and settings you
            create inside the product.
          </li>
          <li>
            <strong>Technical data</strong> — device, browser, and log data required to run
            the service securely.
          </li>
          <li>
            <strong>Analytics</strong> — anonymised usage metrics via Google Analytics 4,
            only if you grant analytics consent.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            Understand aggregate usage patterns (only where you've opted in to analytics).
          </li>
        </ul>
        ...
        <p>
          ...
          analytics cookies. Full detail lives in our{" "}
        ...
        <p>
          Sandbox data is retained while your account is active. You can delete your account
          at any time from Settings; residual backups age out on our standard schedule.
        </p>

...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Smart Pay Engine — Sandbox" },
      { name: "description", content: "Multi-currency smart payments — sandbox prototype." },
      { name: "author", content: "Smart Pay Engine" },
      { property: "og:title", content: "Smart Pay Engine" },
      { property: "og:description", content: "Multi-currency smart payments — sandbox prototype." },

...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      account_type: "checking" | "funding" | "fx_suspense" | "tax_setaside" | "fee_revenue";
      ...
      tx_state: "initiated" | "confirmed" | "completed" | "failed" | "processing" | "reversed";
...
export const Constants = {
  public: {
    Enums: {
      ...
      payment_method: ["card", "paypal", "bank_transfer"],
      product_category: ["crop", "livestock", "dairy", "poultry", "other"],
      reversal_status: ["submitted", "under_review", "approved", "partially_approved", "rejected"],
      tx_state: ["initiated", "confirmed", "completed", "failed", "processing", "reversed"],
      tx_type: ["deposit", "withdrawal", "transfer", "fx", "reversal"],
    },
  },
